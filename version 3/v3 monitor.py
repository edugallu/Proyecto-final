...
def monitorizar_sistema(duracion=30, intervalo=2):
...
# Ejecutar la monitorización (duración total de 30 segundos, con intervalos de 2 segundos)
if __name__ == "__main__":
    monitorizar_sistema(duracion=30, intervalo=2)
